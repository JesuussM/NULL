...
/*
    ...
    Cmdline:
        sokol-shdc --input src/assets/shaders/triangle.glsl --output src/assets/shaders/triangle.glsl.h --slang hlsl5
    ...
    Bindings:
        Uniform block 'mvp_block':
            C struct: mvp_block_t
            Bind slot: UB_mvp_block => 0
*/
...
#define UB_mvp_block (0)
#pragma pack(push,1)
SOKOL_SHDC_ALIGN(16) typedef struct mvp_block_t {
    float mvp[16];
} mvp_block_t;
#pragma pack(pop)
/*
    cbuffer mvp_block : register(b0)
    {
...
static const uint8_t vs_source_hlsl5[748] = {
    0x63,0x62,0x75,0x66,0x66,0x65,0x72,0x20,0x6d,0x76,0x70,0x5f,0x62,0x6c,0x6f,0x63,
